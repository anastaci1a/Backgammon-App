...
static class Settings {
  ...
  static final int   PIECES_PER_COLOR               = 15;      // only used for home spacing, this doesn't determine the piece amount
  ...
  // particles
  static final float PARTICLE_MAGICAL_SIZE_PERCENT = 0.5; // percent of dice size
